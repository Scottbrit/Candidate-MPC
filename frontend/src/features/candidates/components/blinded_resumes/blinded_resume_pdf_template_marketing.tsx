...
const BlindedResumeTemplateMarketing = ({ data }: { data: CandidateExtractedData }) => {
    ...
    const candidateData = {
        ...
        growthTrackRecordAccomplishment: data?.qualifications?.growth_track_record?.join('\n\n') || 
            "[No information provided]",
        abilityToScaleAccomplishment: data?.qualifications?.ability_to_scale?.join('\n\n') || 
            "[No information provided]",
        marketingChannelExpertiseAccomplishment: data?.qualifications?.marketing_channel_expertise?.join('\n\n') || 
            "[No information provided]",
        ...
        <Document>
            ...
            <View style={{ paddingHorizontal: '40pt' }}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Proven Growth Track Record</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.growthTrackRecordAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                        ...
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.abilityToScaleAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Marketing Channel Expertise</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.marketingChannelExpertiseAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
...
export default BlindedResumeTemplateMarketing;
