...
const BlindedResumeTemplateEngineering = ({ data }: { data: CandidateExtractedData }) => {
    ...
    const candidateData = {
        ...
        technicalAreasAndStackAccomplishment: data?.qualifications?.technical_areas_and_stack?.join('\n\n') || 
            "[No information provided]",
        systemsAndProblemsTackledAccomplishment: data?.qualifications?.systems_and_problems_tackled?.join('\n\n') || 
            "[No information provided]",
        impactAndOutcomesAccomplishment: data?.qualifications?.impact_and_outcomes?.join('\n\n') || 
            "[No information provided]",
        scopeAndLeadershipAccomplishment: data?.qualifications?.scope_and_leadership?.join('\n\n') || 
            "[No information provided]",
        ...
        <Document>
            ...
            <View style={{ paddingHorizontal: '40pt' }}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Technical Areas & Stack</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.technicalAreasAndStackAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Systems & Problems Tackled</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.systemsAndProblemsTackledAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                    ...
                    <View style={styles.tableRowLast} wrap={false}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Scope & Leadership</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.scopeAndLeadershipAccomplishment || ''}</Text>
                        </View>
                    </View>
                </View>
...
export default BlindedResumeTemplateEngineering;
