...
const BlindedResumeTemplateProduct = ({ data }: { data: CandidateExtractedData }) => {
    ...
    const candidateData = {
        ...
        productScopeAndOwnershipAccomplishment: data?.qualifications?.product_scope_and_ownership?.join('\n\n') || 
            "[No information provided]",
        coreResponsibilitiesAccomplishment: data?.qualifications?.core_responsibilties?.join('\n\n') || 
            "[No information provided]",
        impactAndOutcomesAccomplishment: data?.qualifications?.impact_and_outcomes?.join('\n\n') || 
            "[No information provided]",
        collaborationAndTeamContextAccomplishment: data?.qualifications?.collaboration_and_team_context?.join('\n\n') || 
            "[No information provided]",
        ...
        <Document>
            ...
            <View style={{ paddingHorizontal: '40pt' }}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Product Scope and Ownership</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.productScopeAndOwnershipAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Core Responsibilities</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.coreResponsibilitiesAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Impact and Outcomes</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                    ...
                    <View style={styles.tableRowLast} wrap={false}>
                        ...
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.collaborationAndTeamContextAccomplishment || ''}</Text>
                        </View>
                    </View>
                </View>
...
export default BlindedResumeTemplateProduct;
