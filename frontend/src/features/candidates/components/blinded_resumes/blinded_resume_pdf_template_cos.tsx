...
const BlindedResumeTemplateCOS = ({ data }: { data: CandidateExtractedData }) => {
        ...
        <Document>
            ...
            <View style={{ paddingHorizontal: '40pt' }}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Ability to build 0 - 1 and 1 - 100</Text>
                        </View>
                        <View style={styles.tableColLast70}>
...
export default BlindedResumeTemplateCOS;
