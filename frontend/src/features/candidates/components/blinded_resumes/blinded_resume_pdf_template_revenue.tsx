...
const BlindedResumeTemplateRevenue = ({ data }: { data: CandidateExtractedData }) => {
    ...
    const candidateData = {
        ...
        revenueSuccessTrackRecordAccomplishment: data?.qualifications?.revenue_success_track_record?.join('\n\n') || 
            "[No information provided]",
        abilityToScaleZeroToOneToHundredAccomplishment: data?.qualifications?.ability_to_scale_zero_to_one_to_hundred?.join('\n\n') || 
            "[No information provided]",
        gtmMotionExpertiseAccomplishment: data?.qualifications?.gtm_motion_expertise?.join('\n\n') || 
            "[No information provided]",
        businessImpactAccomplishment: data?.qualifications?.business_impact?.join('\n\n') || 
            "[No information provided]",
        leadershipAndTeamBuildingAccomplishment: data?.qualifications?.leadership_and_team_building?.join('\n\n') || 
            "[No information provided]",
        ...
        <Document>
            ...
            <View style={{ paddingHorizontal: '40pt' }}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Revenue Success Track Record</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.revenueSuccessTrackRecordAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Ability to go 0-1, 1-100</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.abilityToScaleZeroToOneToHundredAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>GTM Motion Expertise</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.gtmMotionExpertiseAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Business Impact</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.businessImpactAccomplishment || ''}</Text>
                        </View>
                    </View>
                    <View style={styles.tableRowLast} wrap={false}>
                        <View style={styles.tableCol30}>
                            <Text style={styles.tableCell}>Leadership & Team Building</Text>
                        </View>
                        <View style={styles.tableColLast70}>
                            <Text style={styles.tableCell}>{candidateData.leadershipAndTeamBuildingAccomplishment || ''}</Text>
                        </View>
                    </View>
                </View>
...
export default BlindedResumeTemplateRevenue;
