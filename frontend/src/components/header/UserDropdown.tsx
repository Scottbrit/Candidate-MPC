  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <svg
          className={`stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 ml-2 ${
            isOpen ? "rotate-180" : ""
          }`}
          width="18"
          height="20"
      ...
      >
        <div>
          ...
          <span className="mt-1 inline-block px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">
            {getRoleBadge()}
          </span>
        </div>
